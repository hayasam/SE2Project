...
\WHILE{true}
	...
	\STATE $firstReservation=reservationList.GET(first)$ \COMMENT{The next reservation is got from the list}
	\STATE $reservationList.REMOVE(firstReservation)$ \COMMENT{The next reservation is removed from it}
